...
function getIndex() {
    index = Math.floor(Math.random() * noIdeaPool.length);
...
function submitHelp() {
    helpText = document.getElementById("helpBox").value;
    ...
    if (helpText.includes("answer")) {
    ...
    } else if (helpText == "what is a dog") {
        ...
        switch (googles) {
            ...
            case 10: answer.insertAdjacentHTML("beforeend", "<a style=\"color:darkred;font-size:69px;\">GOOGLE</a>"); answer.classList.add("shaking"); break;
            case 11: answer.insertAdjacentHTML("beforeend", "<a style=\"color:darkred;font-size:69px;\">AAAAAAAAAAHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH</a>"); answer.classList.add("shaking"); break;
            default: answer.insertAdjacentHTML("beforeend", "<a style=\"color:darkred;font-size:69px;\">AAAAAAAAAAHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH</a>"); answer.classList.add("shaking"); break;
        }
        googles++;
